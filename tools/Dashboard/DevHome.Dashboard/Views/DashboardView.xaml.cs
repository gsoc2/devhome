...
public partial class DashboardView : ToolPage
{
    ...
    private async Task InitializeDashboard()
    {
        ...
        await ViewModel.WidgetHostingService.EnsureWidgetServiceAsync();
        var widgetServiceState = ViewModel.WidgetHostingService.GetWidgetServiceState();

        if (widgetServiceState == WidgetHostingService.WidgetServiceStates.HasStoreWidgetService ||
            widgetServiceState == WidgetHostingService.WidgetServiceStates.HasWebExperienceGoodVersion)
        {
        ...
        else if (widgetServiceState == WidgetHostingService.WidgetServiceStates.HasNoStoreWidgetService)
        {
