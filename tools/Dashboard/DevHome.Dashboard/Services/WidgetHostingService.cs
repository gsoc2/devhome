...
public class WidgetHostingService : IWidgetHostingService
{
    ...
    private const string _webExpPackageFamilyName = "MicrosoftWindows.Client.WebExperience_cw5n1h2txyewy";
    ...
    private bool HasValidWebExperiencePack()
    {
        ...
        var packages = _packageDeploymentService.FindPackagesForCurrentUser(
            _webExpPackageFamilyName,
            (minSupportedVersion400, version500),
            (minSupportedVersion500, null));
        return packages.Any();
    }

    private bool HasBadWebExperiencePack()
    {
        var packages = _packageDeploymentService.FindPackagesForCurrentUser(_webExpPackageFamilyName);
        return packages.Any();
    }
